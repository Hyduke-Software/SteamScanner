...
apikey      = "SSSOONNNIIICCC111199999992222420"  #enter your API key from https://steamcommunity.com/dev/apikey
userid      = "99999999999999999"                 #enter the userID from Steam
